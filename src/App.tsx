    ...
    <div className="min-h-screen bg-[#0a0f2c] text-white font-sans selection:bg-[#4da3ff] selection:text-black">
      ...
      <header className="sticky top-0 z-50 bg-gradient-to-r from-[#0d6efd] to-[#001f5b] px-6 py-4 flex justify-between items-center shadow-lg">
        ...
        <div className="flex items-center gap-3">
          <a 
            href="https://analytics.vgdh.io/zayed-tau.vercel.app" 
            target="_blank" 
            className="flex items-center gap-1.5 text-[10px] font-bold uppercase text-[#4da3ff] hover:text-white transition-colors bg-[#0a0f2c]/50 px-2 py-1 rounded border border-[#4da3ff]/30"
          >
          ...
          <Card title="Community Links" icon={Link}>
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                { name: "Verse App", url: "https://ai.studio/apps/914ec505-474f-40fa-a226-febeae9c02c7" }
              ].map((link) => (
                <a 
                  key={link.name}
                  href={link.url} 
